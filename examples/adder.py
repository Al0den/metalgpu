...
buffer1 = instance.create_buffer(buffer_size, 0, buffer_type) # Create a shared gpu-cpu buffer. Can be accessed as a numpy array from buffer1.contents
...
instance.run_function(buffer_size) # Computes i + sqrt(i)
